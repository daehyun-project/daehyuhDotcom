...
function call2() {
        ...
        function Calculation1() {
            ...
            if ((Number(120) - Number(threetier) - Number(fourtier) * 4 - Number(fivetier) * 20) >= 0) {
                ...
                document.getElementById("re2").value = Number(threeup) + ' روبل';
                document.getElementById("re3").value = Number(fourup) + ' روبل';
                document.getElementById("re4").value = Number(threeup) + Number(fourup) + Number(1000000) + ' روبل';
            } else {
                document.getElementById("re").value = 'خطأ';
                document.getElementById("re2").value = 'خطأ';
                document.getElementById("re2").value = 'خطأ';
                document.getElementById("re3").value = 'خطأ';
                document.getElementById("re4").value = 'خطأ';
            }
        }
...
function Calculation2() {
    ...
    document.getElementById("mailre").value =  last + ' روبل';
    if (last < 0) {
...
function Calculation3() {
    ...
    document.getElementById("dayruna").value = Math.floor(a/42);
